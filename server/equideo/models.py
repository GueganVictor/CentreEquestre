...
class User(AbstractBaseUser):
    ...
    license_regex = RegexValidator(
        r'^[0-9]{7}([A-z])$', "Merci d'entrer un numéro de licence correct (7 chiffres 1 lettre)")
    phone_regex = RegexValidator(r'^(?:(?:\+|00)33|0)\s*[1-9](?:[\s.-]*\d{2}){4}$', (
        "Merci d'entrer un numéro de téléphone français correct (format +33 ou 0x)"))
...
class Lesson(models.Model):
    ...
    gallop_level = models.IntegerField(
